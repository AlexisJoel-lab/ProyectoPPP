                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <asp:TextBox ID="TextDireccion" runat="server" CssClass="form-control" TabIndex="7" required="required"></asp:TextBox>
                                </div>
                            </div>
                            <div class="field item form-group">
                                <label class="col-form-label col-md-3 col-sm-3  label-align">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <asp:TextBox ID="txtDepartamento" runat="server" CssClass="form-control" TabIndex="7" required="required"></asp:TextBox>
                                </div>
                            </div>
                            <div class="field item form-group">
                                <label class="col-form-label col-md-3 col-sm-3  label-align">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <asp:TextBox ID="txtProvincia" runat="server" CssClass="form-control" TabIndex="8" required="required"></asp:TextBox>
                                </div>
                            </div>
                            <div class="field item form-group">
                                <label class="col-form-label col-md-3 col-sm-3  label-align">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <asp:TextBox ID="TextDistrito" runat="server" CssClass="form-control" TabIndex="8" required="required"></asp:TextBox>
                                </div>
                            </div>
                            <div class="field item form-group">
                                <label class="col-form-label col-md-3 col-sm-3  label-align">
